...
class PatientPrescriptionRecord extends Model
{
    ...
    protected $fillable = [
        'patient_id', 'visit_date', 'complaints', 'on_examination',
        'pastHistory', 'drugHistory', 'investigation', 'diagnosis',
        'treatmentPlan', 'operationNote', 'advice', 'nextPlan',
        'hospitalizations', 'next_visit_date',
